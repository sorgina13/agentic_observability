...
async def main() -> None:
    ...
    async with DefaultAzureCredential() as credential:
        async with AIProjectClient(
            ...
            # Pass the workflow as a factory so from_agent_framework uses
            # AgentFrameworkWorkflowAdapter, which creates a fresh WorkflowAgent
            # per request — preventing state leaking between calls.
            await from_agent_framework(lambda: workflow).run_async()
